...
struct SERVER {
    ...
    char*   password[20];        // password for st�rkeste signal
    char*   encryption[20];      // krytering for st�rkeste signal
    ...
    bool    clientAvailable;     // ... og har vi fået en foresp�rgsel
 ...
 * Er funktioner som forbinder til et eksisterende netv�rk. 
 ...
 * Leverer og h�ndterer HTML sider og HTTP GET requests
 */
