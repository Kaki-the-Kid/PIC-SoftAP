...
void main(void)
{
    ...
    do { states.ok = 0; states.error = 0; states.ready = 0; } while (0);;
    do { strcpy((char*)server.ssid, ""); server.wifiMode = 1; server.multibleConnections = 1; server.maxConnections = 1; server.wificonnected = 0; server.wifigotip = 0; server.internet = 0; server.running = 0;} while (0);;
