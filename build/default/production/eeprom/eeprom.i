...
# 133 "eeprom/../mcc_generated_files/tmr2.h"
void TMR2_StartTimer(void);
# 165 "eeprom/../mcc_generated_files/tmr2.h"
void TMR2_StopTimer(void);
# 200 "eeprom/../mcc_generated_files/tmr2.h"
uint8_t TMR2_ReadTimer(void);
# 239 "eeprom/../mcc_generated_files/tmr2.h"
void TMR2_WriteTimer(uint8_t timerVal);
# 291 "eeprom/../mcc_generated_files/tmr2.h"
void TMR2_LoadPeriodRegister(uint8_t periodVal);
# 309 "eeprom/../mcc_generated_files/tmr2.h"
void TMR2_ISR(void);
# 327 "eeprom/../mcc_generated_files/tmr2.h"
 void TMR2_CallBack(void);
# 344 "eeprom/../mcc_generated_files/tmr2.h"
 void TMR2_SetInterruptHandler(void (* InterruptHandler)(void));
# 362 "eeprom/../mcc_generated_files/tmr2.h"
...
# 133 "eeprom/../mcc_generated_files/tmr4.h"
void TMR4_StartTimer(void);
# 165 "eeprom/../mcc_generated_files/tmr4.h"
void TMR4_StopTimer(void);
# 200 "eeprom/../mcc_generated_files/tmr4.h"
uint8_t TMR4_ReadTimer(void);
# 239 "eeprom/../mcc_generated_files/tmr4.h"
void TMR4_WriteTimer(uint8_t timerVal);
# 291 "eeprom/../mcc_generated_files/tmr4.h"
void TMR4_LoadPeriodRegister(uint8_t periodVal);
# 309 "eeprom/../mcc_generated_files/tmr4.h"
void TMR4_ISR(void);
# 327 "eeprom/../mcc_generated_files/tmr4.h"
 void TMR4_CallBack(void);
# 344 "eeprom/../mcc_generated_files/tmr4.h"
 void TMR4_SetInterruptHandler(void (* InterruptHandler)(void));
# 362 "eeprom/../mcc_generated_files/tmr4.h"
...
# 57 "eeprom/../mcc_generated_files/eusart1.h" 2
# 76 "eeprom/../mcc_generated_files/eusart1.h"
typedef union {
    struct {
        unsigned perr : 1;
        unsigned ferr : 1;
...
# 118 "eeprom/../mcc_generated_files/eusart1.h"
void EUSART1_Initialize(void);
# 166 "eeprom/../mcc_generated_files/eusart1.h"
_Bool EUSART1_is_tx_ready(void);
# 214 "eeprom/../mcc_generated_files/eusart1.h"
_Bool EUSART1_is_rx_ready(void);
# 261 "eeprom/../mcc_generated_files/eusart1.h"
_Bool EUSART1_is_tx_done(void);
# 309 "eeprom/../mcc_generated_files/eusart1.h"
eusart1_status_t EUSART1_get_last_status(void);
# 329 "eeprom/../mcc_generated_files/eusart1.h"
uint8_t EUSART1_Read(void);
# 349 "eeprom/../mcc_generated_files/eusart1.h"
void EUSART1_Write(uint8_t txData);
# 370 "eeprom/../mcc_generated_files/eusart1.h"
void EUSART1_Transmit_ISR(void);
# 391 "eeprom/../mcc_generated_files/eusart1.h"
void EUSART1_Receive_ISR(void);
# 412 "eeprom/../mcc_generated_files/eusart1.h"
void EUSART1_RxDataHandler(void);
# 430 "eeprom/../mcc_generated_files/eusart1.h"
void EUSART1_SetFramingErrorHandler(void (* interruptHandler)(void));
# 448 "eeprom/../mcc_generated_files/eusart1.h"
void EUSART1_SetOverrunErrorHandler(void (* interruptHandler)(void));
# 466 "eeprom/../mcc_generated_files/eusart1.h"
void EUSART1_SetErrorHandler(void (* interruptHandler)(void));
# 486 "eeprom/../mcc_generated_files/eusart1.h"
...
const uint8_t eeprom_addr = 0b1010000;
...
const char eeprom_pointer[] = {0x00, 0x00};
...
void eeprom_testData(void) {
    ...
    i2c_write_serial(eeprom_addr, (char*) eeprom_test, 17);
    printf("Skrivning faerdig\r\n");

    i2c_write_serial(eeprom_addr, (char*) eeprom_pointer, 2);
...
void eeprom_initEeprom(void) {
    ...
    i2c_write_serial(eeprom_addr, (char*) eeprom_init, 6);
    i2c_write_serial(eeprom_addr, (char*) eeprom_pointer, 2);
}
...
void eeprom_dumpLogData(void) {
    ...
    while ( i <= i_max ) {
        i2c_read_serial(eeprom_addr, (uint8_t*) eeprom_buffer, 8);


        j = 0;
        while ( j < 8 ) {

            tmp_humid = (uint32_t)(( eeprom_buffer[j++] & (char)0b00111111 ) << (char)8);
            ...
            sprintf((char*) tmp, (const char*) eeprom_template, tmp_humid, tmp_temp );
            strcat(msg, tmp);
        }

        printf( "AT+CIPSEND=0,%d\r\n", (const char*) strlen(msg) );
